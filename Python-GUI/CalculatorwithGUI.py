...
btn_mul = Button(root, text='x', bg='white',fg='black',width=5,height=2, command=lambda : get_operator('x'))
...
btn_equals = Button(root, text='=', bg='white',fg='black',width=5,height=2)
