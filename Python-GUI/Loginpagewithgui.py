...
def handle_login():
    ...
    if email == 'nishat@gmail.com' and password == '1234':
...
img = Image.open('Flipkartlogo.png')
...
login_btn = Button(root, text='Login', bg='white', fg='black', width=20, height=2)
